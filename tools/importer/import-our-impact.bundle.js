...
var CustomImportScript = (() => {
  ...
  // tools/importer/import-our-impact.js
  var import_our_impact_exports = {};
  __export(import_our_impact_exports, {
    default: () => import_our_impact_default
  });

  // tools/importer/parsers/hero-impact.js
  function parse(element, { document: document2 }) {
    ...
    cells.push([textCell]);
    const block = WebImporter.Blocks.createBlock(document2, { name: "hero-impact", cells });
  ...
  return __toCommonJS(import_our_impact_exports);
})();
